...
exportgraphics(gcf,'figs2/fig01_P01_PEN_X1_POW.png','Resolution',500)
% exportgraphics(gcf,'figs2/fig02_P01_PEN_X2_FR.png','Resolution',500)
end
...
for m = [1]
    ...
    while k < iter_max
        ...
        if m == plot_model
            ...
            c2_plot = [];
            intervals = intervals*10;
%             plot_phi(-3,3,0,9, phib1_plot, intervals, c_plot, x_values, tit, k, i , j);
...
% exportgraphics(gcf,'figs2/fig03_P01_BAR_X1_UNI.png','Resolution',500)
exportgraphics(gcf,'figs2/fig04_P01_BAR_X2_SD.png','Resolution',500)
end
...
% exportgraphics(gcf,'figs2/fig05_P02_PEN_X1_FR.png','Resolution',500)
exportgraphics(gcf,'figs2/fig06_P02_PEN_X2_UNI.png','Resolution',500)
end
...
% exportgraphics(gcf,'figs2/fig07_P02_BAR_X1_NR.png','Resolution',500)
exportgraphics(gcf,'figs2/fig08_P02_BAR_X2_FR.png','Resolution',500)
end
